	...
	<form method="post" action="register_choose_picture.html">
		...
		<table width="100%" border="1" cellpadding=3 cellspacing=1
			...
			<tr>
				...
				<td class="TD_STYLE2"><select name="humanFile.humanMajorKindId"
					class="SELECT_STYLE1" id="majorKind">
						<option>销售</option>
						<option>软件开发</option>
				</select> <input type="hidden" name="humanFile.humanMajorKindName" /></td>
				<td class="TD_STYLE1">职位名称</td>
				<td class="TD_STYLE2"><select name="humanFile.humanMajorId"
					class="SELECT_STYLE1" id="majorName">
						<option>区域经理</option>
						<option>总经理</option>
				</select> <input type="hidden" name="humanFile.hunmaMajorName" /></td>
				<td class="TD_STYLE1">职称</td>
				<td colspan="2" class="TD_STYLE2"><select
					name="humanFile.humanProDesignation" class="SELECT_STYLE1">
						<option>工程师</option>
						<option>助理</option>
						<option>经理</option>
				</select></td>
			...
			<tr>
				...
				<td class="TD_STYLE2"><input type="text" id="humanName"
					name="humanFile.humanName" class="INPUT_STYLE2" /></td>
				<td class="TD_STYLE1">性别</td>
				<td class="TD_STYLE2"><select name="humanFile.humanSex"
					class="SELECT_STYLE1">
				...
				<td colspan="2" class="TD_STYLE2"><input type="text"
					name="humanFile.humanEmail" id="humanEmail" class="INPUT_STYLE2"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">电话</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanTelephone" id="humanTelephone"
					class="INPUT_STYLE2"></td>
				<td class="TD_STYLE1">QQ</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanQq" id="humanQq" class="INPUT_STYLE2"></td>
			...
			<tr>
				...
				<td colspan="3" class="TD_STYLE2"><input type="text"
					name="humanFile.humanAddress" class="INPUT_STYLE2"></td>
				<td class="TD_STYLE1">邮编</td>
				<td colspan="2" class="TD_STYLE2"><input type="text"
					name="humanFile.humanPostcode" class="INPUT_STYLE2"></td>
			</tr>
			<tr>
				...
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanBirthplace" class="INPUT_STYLE2"></td>
				...
				<td class="TD_STYLE2" width="14%"><select
					name="humanFile.humanRace" class="SELECT_STYLE1">
						<option>汉族</option>
						<option>回族</option>
				</select></td>
			</tr>
			<tr>
				...
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanIdCard" id="humanIdCard" class="INPUT_STYLE2"></td>
				<td class="TD_STYLE1">社会保障号码</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanSocietySecurityId" class="INPUT_STYLE2"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">年龄</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanAge" id="humanAge" class="INPUT_STYLE2"></td>
			...
			<tr>
				...
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanBank" class="INPUT_STYLE2"></td>
				<td class="TD_STYLE1">帐号</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.humanAccount" class="INPUT_STYLE2"></td>
				<td class="TD_STYLE1">登记人</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.register" value="谢鹏" readonly="readonly"
					class="INPUT_STYLE2"></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">建档时间</td>
				<td class="TD_STYLE2"><input type="text"
					name="humanFile.registTime" id="create_time" readonly="readonly"
					class="INPUT_STYLE2"></td>
