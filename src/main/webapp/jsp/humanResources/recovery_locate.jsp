...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="stylesheet" href="../../css/cwcalendar.css" type="text/css">
		...
		<script type="text/javascript" src="../../javascript/comm/list.js">
		...
		<script type="text/javascript" src="../../javascript/locate.js">
			
		</script>
</head>

<body>
	<form method="post" action="recovery_list.html">
		<table width="100%">
			<tr>
				<td><font color="black">您正在做的业务是：人力资源--人力资源档案管理--人力资源档案恢复</font>
				</td>
			</tr>
			<tr>
				<td align="right"><input type="submit" value="查询"
					class="BUTTON_STYLE1" /> <input type="button" value="搜索"
					class="BUTTON_STYLE1"
					onclick="location.href='recovery_keywords.html'"></td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr class="TR_STYLE1">
				...
				<td width="84%" class="TD_STYLE2"><select
					name="humanFile.firstKindId" size="5" id="firstKind"
					class="SELECT_STYLE2">
			...
			<tr>
				...
				<td width="84%" class="TD_STYLE2"><select
					name="humanFile.humanMajorKindId" size="5" id="majorKind"
					class="SELECT_STYLE2">
						<option value="" selected="selected">全部</option>
			...
			<tr class="TR_STYLE1">
				...
				<td width="84%" class="TD_STYLE2"><select
					name="humanFile.humanMajorId" size="5" class="SELECT_STYLE2"
					id="majorName">
						<option value="" selected="selected">全部</option>
